...
--              [ CTRL+Numpad4 ]    Blade: Shun
--              [ CTRL+Numpad8 ]    Blade: Ten
...
function user_setup()
    ...
    send_command('bind ^numpad4 input /ws "Blade: Shun" <t>')
    send_command('bind ^numpad8 input /ws "Blade: Ten" <t>')
...
function init_gear_sets()
    ...
    sets.precast.FC = {
        ammo="Sapience Orb", --2
        head={ name="Herculean Helm", augments={'"Cure" potency +10%','"Fast Cast"+6','"Refresh"+1','Accuracy+12 Attack+12','Mag. Acc.+5 "Mag.Atk.Bns."+5',}}, --13
        ...
        ring2="Prolix Ring", --2
        back={ name="Andartia's Mantle", augments={'Eva.+20 /Mag. Eva.+20','"Fast Cast"+10','Spell interruption rate down-10%',}},--10
        waist="Sailfi Belt +1", 
        }
    ...
    sets.precast.WS = {
        ammo="Seeth. Bomblet +1", --***Dyna 
        --head="Hachiya Hatsu. +2", --***Only has WSD at +2
        head="Nyame Helm",
        body="Nyame Mail",
    ...
    sets.precast.WS['Blade: Ten'] = set_combine(sets.precast.WS, {
        --Most efficient damage at 2000 tp (after TP bonus equipment)
        head="Mpaca's Cap",
        neck="Ninja Nodowa +1",
        feet="Hattori Kyahan +3",
        ear2="Lugra Earring +1",
    ...
    sets.precast.WS['Blade: Chi'].Acc = set_combine(sets.precast.WS['Blade: Shun'], {
        --***Needs input
        ammo="Voluspa Tathlum",
        legs="Ken. Hakama +1",
        })
    ...
    sets.precast.WS['Blade: Kamu'] = set_combine(sets.precast.WS, {
        --lowers enemy Acc and increases attack with mythic (Nagi)
        head="Mpaca's Cap",
        legs="Mpaca's Hose",
        feet="Hattori Kyahan +3",
        ring2="Ilabrat Ring",
    ...
    sets.precast.WS['Blade: Yu'] = set_combine(sets.precast.WS, {
        ...
        ring1="Regal Ring",
        ring1="Sroda Ring",
        back={ name="Andartia's Mantle", augments={'INT+20','Mag. Acc+20 /Mag. Dmg.+20','INT+10','"Mag.Atk.Bns."+10','Spell interruption rate down-10%',}},
        waist="Eschan Stone",
        })
    ...
    sets.precast.WS['Evisceration'] = set_combine(sets.precast.WS, {
        ...
        --hands="Ryuo Tekko +1", --Path A or C
        hands="Mummu Wrists +2", --Better than Herc Hands WSD +10 b/c of Crit Hit rate
        --legs="Mpaca's Hose",
        legs="Jokushu Haidate",
...
--    sets.resting = {}
    ...
    sets.idle = {
        ...
        back={ name="Andartia's Mantle", augments={'Eva.+20 /Mag. Eva.+20','"Fast Cast"+10','Spell interruption rate down-10%',}},
        waist="Engraved Belt",
        }
    ...
    sets.idle.Town = set_combine(sets.idle, {
        ...
        body="Ken. Samue +1",
        hands="Ken. Tekko +1",
        legs="Mochi. Hakama +3", --***Only has WSD at +2
    ...
    sets.engaged = {
    -- No Magic Haste + 35 DW = 39 DW to cap
        --ammo="Seki Shuriken",
        ammo="Date Shuriken",
        --head="Ryuo Somen +1", --9
        head="Malignance Chapeau",
        ...
        back={ name="Andartia's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','DEX+10','"Dbl.Atk."+10','Phys. dmg. taken-10%',}}, --Need DEX and DW cape
        waist="Reiki Yotai", --7
      } -- 38%
    ...
    --15% Magic Haste + 35 DW = 32 DW to cap
        --ammo="Seki Shuriken",
        ammo="Date Shuriken",
        --head="Ryuo Somen +1", --9
        head="Malignance Chapeau",
    ...
    --30% Magic Haste + 35 DW = 21 DW to cap
        --ammo="Seki Shuriken",
        ammo="Date Shuriken",
        --head="Ryuo Somen +1", --9, Path C
        head="Malignance Chapeau",
        body="Adhemar Jacket +1",
        hands="Malignance Gloves",
        legs="Samnuha Tights",
        ...
        ring2="Epona's Ring",
        --back=gear.NIN_TP_Cape,
        back={ name="Andartia's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','DEX+10','"Dbl.Atk."+10','Phys. dmg. taken-10%',}}, --Need DEX and stp cape
        waist="Reiki Yotai", --7
        } -- 21%
    ...
    --35% Magic Haste + 35 DW = 16 DW to cap
    --***Needs input
        --ammo="Seki Shuriken",
        ammo="Date Shuriken",
        head="Malignance Chapeau",
    ...
    -- 45% Magic Haste + 35 DW = 1 DW to cap
        --ammo="Seki Shuriken",
        ammo="Date Shuriken",
        head="Malignance Chapeau",
