...
--              [ WIN+. ]           Utsusemi: Ni
--
--  WS:         [ CTRL+Numpad4 ]    Savage Blade
--              [ CTRL+Numpad6 ]    Chant Du Cygne
...
function job_setup()
    ...
    -- Fast Recast
    blue_magic_maps.FastRecast = S{'Reaving Wind','Feather Tickle'}
...
function user_setup()
    ...
    state.WeaponSet = M{['description']='Weapon Set', 'NaeglingZantet', 'NaeglingTPBonus', 'Maxentius', 'TizonaZantet', 'TizonaThibron'}
    --state.WeaponSet = M{['description']='Weapon Set', 'NaeglingZantet', 'NaeglingTPBonus', 'Maxentius', 'Sakpata', 'Almace'}
    ...
    --loads Azure Sets lua for setting blue mage spells
...
function init_gear_sets()
    ...
    sets.buff['Burst Affinity'] = {legs="Assim. Shalwar +2", feet="Hashishin Basmak +3"}
    ...
    sets.precast.FC = {
        --Max 80% fast cast from gear
        --Erratic Flutter for BLU job trait gives +5. Job Points bonus at 100 and 1200 give +5 each for +15 total. 65 FC needed. +15 if /RDM
        ammo="Sapience Orb", --2
    ...
    --Modifiers: 73-85% MND depending on Merit
        head="Hashishin Kavuk +3",
        --body="Gleti's Cuirass",
        body="Nyame Mail",
        hands="Nyame Gauntlets",
    ...
    sets.midcast.FastRecast = {
        --For Reaving Wind and Feather Tickle in Odyssey
        ammo="Sapience Orb",
        head="Hashishin Kavuk +3",
        ...
        ring1 = {name="Stikini Ring +1", bag="Wardrobe 2", priority = 1},
        ring2="Kishar Ring",
        back={ name="Rosmerta's Cape", augments={'INT+20','Mag. Acc+20 /Mag. Dmg.+20','INT+10','"Mag.Atk.Bns."+10','Spell interruption rate down-10%',}},
        waist="Witful Belt",
        }
    ...
    sets.midcast['Blue Magic'] = {
        --Blue magic skill at Mastered: 460
        --+1 skill per master level. Currently: 19
        ammo="Mavi Tathlum", --5
        head="Luh. Keffiyeh +3", --17
        body="Assim. Jubbah +3", --24
        hands="Rawhide Gloves", --10
        legs="Hashishin Tayt +3", --33
        feet="Luhlaza Charuqs +3", --12 , +3 gives 33
        neck="Mirage Stole +2", --20
        --ear1="Njordr Earring", -10
        ear2="Hashishin Earring +1", --11
        ring1 = {name="Stikini Ring +1", bag="Wardrobe 2", priority = 1}, --8
        ring2 = {name="Stikini Ring +1", bag="Wardrobe 5", priority = 2}, --8
        back="Cornflower Cape", --5 +8 out of 10
        --total skill: 635
        }
    ...
    sets.midcast['Blue Magic'].PhysicalInt = set_combine(sets.midcast['Blue Magic'].Physical, {
        ammo="Ghastly Tathlum +1",
        ear2="Regal Earring",
        ring1="Shiva Ring +1", --*** Mage appropriate ring
        ring2="Metamor. Ring +1",
    ...
    sets.midcast['Blue Magic'].PhysicalMnd = set_combine(sets.midcast['Blue Magic'].Physical, {
        ear2="Regal Earring",
        ring1 = {name="Stikini Ring +1", bag="Wardrobe 2", priority = 1},
        ring2 = {name="Stikini Ring +1", bag="Wardrobe 5", priority = 2},
        back="Aurist's Cape +1",
        })
    ...
    sets.midcast['Blue Magic'].Healing = {
        --For Blue Magic (especially Magic Fruit): Stack Cure Pot (cap 50) and MND. 1 MND = 3 VIT = 5 Healing Skill
        --Total cap: Cure Pot / MND
        -- 67 / 206
        --ammo="Staunch Tathlum +1",
        ammo="Hydrocera", --0/3
        head={ name="Herculean Helm", augments={'"Cure" potency +10%','"Fast Cast"+6','"Refresh"+1','Accuracy+12 Attack+12','Mag. Acc.+5 "Mag.Atk.Bns."+5',}}, --10/16
        body="Vrikodara Jupon", -- 13/29
        hands={ name="Telchine Gloves", augments={'"Cure" potency +8%','Enh. Mag. eff. dur. +10',}}, --18/33
        legs="Hashishin Tayt +3", --0/43
        feet="Medium's Sabots", --Sinister Reign max aug.s Cure pot +5, MND +10 –(7+ 3 of 5)/(19+8 of 10)

        --head="Carmine Mask +1", --Path B
        --body="Pinga Tunic +1", -- 15
        --hands={ name="Telchine Gloves", augments={'"Cure" potency +8%','Enh. Mag. eff. dur. +10',}}, --18
        --legs="Carmine Cuisses +1", --Path B


        --neck="Nuna Gorget +1", --0/9
        neck="Phalaina Locket", --4/3
        ear1="Mendi. Earring", -- 5/0
        ear2="Regal Earring", --0/10
        ring1 = {name="Stikini Ring +1", bag="Wardrobe 2", priority = 1}, --0/8/8 Healing skill
        ring2="Metamorph Ring +1", --0/16
        back="Aurist's Cape +1", --0/33
        waist="Luminary Sash", --0/10
        }

    sets.midcast['Blue Magic'].HealingSelf = set_combine(sets.midcast['Blue Magic'].Healing, {
        --Cap is 30 Self Cure Pot from gear      
        head="Hashishin Kavuk +3",
        legs={ name="Taeon Tights", augments={'Potency of "Cure" effect received+7%','Phalanx +3',}}, -- (7)
        feet="Medium's Sabots", --Sinister Reign max aug.s Cure pot +5, MND +10 –(7+ 3 of 5)/(19+8 of 10)
        neck="Phalaina Locket", -- 4(4)
        ring1="Kunaji Ring", -- (5)
        --ring2="Asklepian Ring", -- (3)
        --back="Solemnity Cape", --7
        back="Moonlight Cape", --for HP swaps
        waist="Gishdubar Sash", -- (10)
        })

    sets.midcast['Blue Magic']['White Wind'] = set_combine(sets.midcast['Blue Magic'].Healing, {
        --HP healed = (Max HP/7)*2
        --Affected by Cure Potency/Received
        --ammo="Egoist's Tathlum", --HP+45
        ammo="Psilomene", --HP+15
        --feet="Carmine Greaves +1", --HP+95 with Path A
        --neck="Unmoving Collar +1", --HP+200 when R15’d
        neck="Sanctity Necklace",
        ear1="Odnowa Earring +1", --Convert MP>HP+110
        --ear2="Tuisto Earring", --HP+150
        ear2="Etiolation Earring",
        ring1="Kunaji Ring", --HP+40, CPR 5
        --ring2="Gelatinous Ring +1", --HP+100 when R15’d
        back="Moonlight Cape", --HP+275
    ...
    sets.midcast.Phalanx = set_combine(sets.midcast.EnhancingDuration, {
        --for self casting phalanx. For potency use the other Phalanx set        
    ...
    sets.idle = {
        ...
        --hands="Malignance Gloves",
        --legs="Malignance Tights",
        legs="Carmine Cuisses +1", --Movement Speed
        --feet="Malignance Boots",
        feet="Nyame Sollerets",
        neck="Bathy Choker +1",
        ear1="Eabani Earring",
        ...
        ear2="Etiolation Earring",
        ring1 = {name="Stikini Ring +1", bag="Wardrobe 2", priority = 1},
        ring2 = {name="Stikini Ring +1", bag="Wardrobe 5", priority = 1},
        back="Moonlight Cape",
    ...
    sets.engaged = {
        ...
        ring1="Hetairoi Ring",
        ring2="Epona's Ring",
        back={ name="Rosmerta's Cape", augments={'DEX+20','Accuracy+20 Attack+20','Accuracy+10','"Dbl.Atk."+10','"Regen"+5',}},
        waist="Reiki Yotai",
        }
    ...
    sets.engaged.Hybrid = {
        ...
        body="Hashishin Mintan +3", --13/13
        hands="Hashishin Bazubands +3", --10/10
        legs="Hashishin Tayt +3", --12/12
    ...
    sets.latent_refresh90 = {
        hands={ name="Herculean Gloves", augments={'Pet: INT+7','DEX+1','"Refresh"+2','Accuracy+9 Attack+9','Mag. Acc.+14 "Mag.Atk.Bns."+14',}},
        head={ name="Herculean Helm", augments={'"Cure" potency +10%','"Fast Cast"+6','"Refresh"+1','Accuracy+12 Attack+12','Mag. Acc.+5 "Mag.Atk.Bns."+5',}},
        }
    ...
    sets.NaeglingZantet = {main="Naegling", sub="Zantetsuken"}
    sets.NaeglingTPBonus = {main="Naegling", sub="Thibron"}
    sets.Maxentius = {main="Maxentius", sub="Bunzi's Rod",}
    sets.TizonaZantet = {main="Tizona", sub="Zantetsuken"}
    sets.TizonaThibron = {main="Tizona", sub="Thibron"}
...
function job_aftercast(spell, action, spellMap, eventArgs)
    if not spell.interrupted then
        ...
        if spell.english == "Cruel Joke" then
            send_command('@timers c "Cruel Joke ['..spell.target.name..']" 60 down spells/00259.png')
        end
    end
...
function customize_idle_set(idleSet)
    ...
    if player.mpp < 91 then
        idleSet = set_combine(idleSet, sets.latent_refresh90)
    end
